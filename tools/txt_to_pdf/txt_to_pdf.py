...
def main():
    parser = argparse.ArgumentParser(description="Merge TXT and Markdown files into a single PDF")
    ...
    txt_files = collect_text_files(input_dir)
    if not txt_files:
        print("[ERROR] No .txt or .md files found in the specified folder.")
        sys.exit(1)
